namespace OVFL.ECS
{
    ...
    /// </summary>
    /// <remarks>
    /// <b>왜 필요한가.</b> 순서를 등록 줄이 정하면 한 줄을 옮기는 것만으로 동작이 바뀌는데
    /// <b>컴파일러도 테스트도 그것을 모른다.</b> 순서에 의미가 있다면 그 의미를 타입이 들고 있어야 한다.
    ///
    ...
    ///
    /// <b>같은 Phase 안의 순서는 등록 순서다.</b> Phase가 정하는 것은 큰 덩어리의 순서이고,
    /// 그 안에서는 적은 순서대로 돈다.

...
namespace OVFL.ECS
{
    ...
    public class Context
    {
        ...
        ///
        /// <b>몇 번째 스텝에 적용될지는 보장하지 않는다.</b> 배출은 <see cref="Systems.Tick"/>과
        /// <see cref="Systems.FixedTick"/> 중 <b>먼저 오는 쪽의 맨 앞</b>에서 하므로, 그보다 먼저
        /// 도착했으면 그 스텝에, 늦었으면 다음 스텝에 적용된다.
        /// 언제 도착할지는 네트워크가 정하는 것이라 어떤 설계로도 못 고정한다.
